...
create table if not exists merchants (
  tenant_id integer not null,
  merchant_id integer primary key generated by default as identity,
  merchant_name text,
  commission float,
  _updated_at timestamp default now()
);
...
insert into merchants(tenant_id, merchant_id, merchant_name, commission) VALUES
  (1, 1, 'Merchant 1', 0.01)
, (1, 2, 'Merchant 2', 0.015)
, (1, 3, 'Merchant 3', 0.02)
on conflict do nothing;

insert into payments(tenant_id, payment_id, reference, amount) values
  (1, 1, 'order 1', 460.00)
, (1, 2, 'order 2', 5000.00)
, (1, 3, 'order 3', 302.00)
, (1, 4, 'order 4', 404.00)
